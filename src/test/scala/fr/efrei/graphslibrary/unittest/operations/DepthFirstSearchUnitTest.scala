...
class DepthFirstSearchUnitTest extends AnyFlatSpec with Matchers {

  "DepthFirstSearch" should "perform depth first search correctly on DirectedGraph" in {
  ...
  "DepthFirstSearch" should "perform depth first search correctly on WeightedDirectedGraph" in {
  ...
  "DepthFirstSearch" should "perform depth first search correctly on UndirectedGraph" in {
  ...
  "DepthFirstSearch" should "perform depth first search correctly on WeightedUndirectedGraph" in {
