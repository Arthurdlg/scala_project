...
class BreadthFirstSearchUnitTest extends AnyFlatSpec with Matchers {

  "BreadthFirstSearch" should "perform depth first search correctly on DirectedGraph" in {
  ...
  "BreadthFirstSearch" should "perform depth first search correctly on WeightedDirectedGraph" in {
  ...
  "BreadthFirstSearch" should "perform depth first search correctly on UndirectedGraph" in {
  ...
  "BreadthFirstSearch" should "perform depth first search correctly on WeightedUndirectedGraph" in {
    ...
    bfsResult shouldEqual List(0,1,2,4,3)
  }
}
